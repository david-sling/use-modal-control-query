...
export function CodeBlock({
  ...
  if (!html) {
    return (
      <div className={cn('relative rounded-md border animate-pulse', className)}>
  ...
  return (
    ...
    >
      <div className="sticky top-5 flex justify-end -mt-8 mr-5">
        <Tooltip>
          <TooltipTrigger className="p-1 rounded-md hover:bg-muted transition" onClick={handleCopy}>
